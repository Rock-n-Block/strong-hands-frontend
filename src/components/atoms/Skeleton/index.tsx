...
export const SkeletonTwoRows = (props: SkeletonProps): any => (
  <Skeleton active title={false} paragraph={{ rows: 2 }} {...props} />
);
export const SkeletonSixRows = (props: SkeletonProps): any => (
  <Skeleton active title={false} paragraph={{ rows: 6 }} {...props} />
);
export const SkeletonTenRows = (props: SkeletonProps): any => (
